...
public class RecentPlayedAdapter extends ArrayAdapter<Music> {
   ...
   ViewHolder holder = null;
    ...
    public RecentPlayedAdapter(Context context, int textViewResourced, List<Music> objects){
    ...
    public View getView(final int position, View convertView, ViewGroup parent){
        ...
        final Button favorite=holder.favorite;
        if(ifliked(music))
        {
            favorite.setBackgroundResource(R.drawable.havelike);
        }
        else {
            favorite.setBackgroundResource(R.drawable.like);
        }
...
//                    }break;
                case R.id.music_delete:
                    ...
                    DataSupport.deleteAll(RecentPlayedMusic.class,"music_id=?",String.valueOf(music1.getMusic_id()));
